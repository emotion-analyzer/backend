...
from util.schemas import AnalysisRequestParameters, DominantEmotion, PostAnalysisResult
...
analysis_result_body = PostAnalysisResult(query_processor_id="id1", code=POST_ANALYSIS_RESULT,
                          ...
                          affective_states={"ira": 0.60}, dominant_emotion=DominantEmotion(
        label="ira", score=1.00)
    )
